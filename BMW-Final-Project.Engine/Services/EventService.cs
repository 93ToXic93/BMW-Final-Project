...
namespace BMW_Final_Project.Engine.Services
{
    public class EventService : IEventService
    {
        ...
        public async Task<bool> IsThisUserHasBeenAddedTheEventAsync(Guid userId, int id)
        {
            return await _repository.AllReadOnly<EventJoiners>().AnyAsync(x => x.JoinerId == userId && x.EventId == id);
        }
