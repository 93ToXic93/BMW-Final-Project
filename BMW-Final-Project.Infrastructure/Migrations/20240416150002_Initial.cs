    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("ab5f19c3-0e66-4a5b-ab4a-ada016abc5c5"), "4cb8e6ad-eac1-4787-8afa-79bd97b668c0", "Admin", "ADMIN" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 0, "c729b90a-6444-4eea-b15c-7fb09589a779", "Adi@gmail.com", false, "Adrian", "Ivanov", true, null, "ToXic", "ADI@GMAIL.COM", "ADI@GMAIL.COM", "AQAAAAEAACcQAAAAEKaArgkSt/KUf16xQKEBLjzPnnIlDcNmPUQ0GkxiG82Ll9euv347MpxOg/zh+o+D3A==", null, false, "8F1EB108-E499-4C92-87C3-CF0F2F443B46", false, "Adi@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Тази година само с BMW ,събитието ще бъде неповторимо, което не трябва да изпускате. Ще има стънт програма и екслузивни мотори. ЗАПОВЯДАЙТЕ!", new DateTime(2026, 2, 3, 19, 0, 0, 0, DateTimeKind.Unspecified), "https://www.bmw-motorrad.com/content/dam/bmwmotorradnsc/marketCORECOM/common/images/experience/stories/brand/bmd-2023/youtube/nsc-bmd-2023-youtube-fallback.jpg.asset.1675938793795.jpg", true, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), "BMW SPORT EVENT", "София, BMW-България", new DateTime(2026, 2, 2, 13, 45, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Тази година, BMW събитието ще бъде неповторимо, което не трябва да изпускате. Ще има стънт програма и екслузивни мотори.Това е 100-годишнината на BMW и желаем да поканим възможно повече хора! ЗАПОВЯДАЙТЕ!", new DateTime(2026, 1, 30, 21, 0, 0, 0, DateTimeKind.Unspecified), "https://i.ytimg.com/vi/2t-m6cuPUqI/maxresdefault.jpg", true, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), "BMW Anniversary", "София, BMW-България", new DateTime(2026, 1, 29, 12, 45, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "BMW - Откриване на сезона, желаем да Ви поканим да открием новият сезон с яркост и красота с нашите нови модели. ЗАПОВЯДАЙТЕ!", new DateTime(2026, 4, 13, 21, 0, 0, 0, DateTimeKind.Unspecified), "https://c.ndtvimg.com/2020-09/9e7k4g2g_bmw-motorrad-days_625x300_18_September_20.jpg", true, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), "BMW new season", "София, BMW-България", new DateTime(2026, 4, 12, 11, 45, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 20, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 1000, 1, "BMW own Dynamic Traction Control specified for this unique bike", "BMW own Front Brake Control specified for this unique bike", 205, "https://images4.alphacoders.com/127/1277784.jpg", true, 197, "BMW S1000RR", 62000m, "BMW own Rear Brake Control specified for this unique bike", 705, 3, 21, "BMW 6-Gears transmission", 1, new DateTime(2024, 4, 16, 18, 0, 2, 472, DateTimeKind.Local).AddTicks(1574) },
                    { 2, 20, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 900, 1, "BMW own Dynamic Traction Control specified for this unique bike", "BMW own Front Brake Control specified for this unique bike", 105, "https://storage.edidomus.it/dueruote/nuovo/850/lat1586861045333.jpg", true, 210, "BMW F900R", 32000m, "BMW own Rear Brake Control specified for this unique bike", 705, 3, 16, "BMW 6-Gears transmission", 4, new DateTime(2024, 4, 16, 18, 0, 2, 472, DateTimeKind.Local).AddTicks(1618) },
                    { 3, 20, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 100, 1, "BMW own Dynamic Traction Control specified for this unique bike", "BMW own Front Brake Control specified for this unique bike", 225, "https://www.procycles.com.au/cdn/shop/files/2023-BMW-M-1000-RR_-16-1024x724.jpg?v=1689145146", true, 190, "BMW M1000RR", 82000m, "BMW own Rear Brake Control specified for this unique bike", 665, 3, 21, "BMW 6-Gears transmission", 2, new DateTime(2024, 4, 16, 18, 0, 2, 472, DateTimeKind.Local).AddTicks(1626) },
                    { 5, 20, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 100, 1, "BMW own Dynamic Traction Control specified for this unique bike", "BMW own Front Brake Control specified for this unique bike", 225, "https://www.bavarianmc.co.za/files/bike/22767/img_20240205160754.jpg", true, 190, "BMW F800R", 82000m, "BMW own Rear Brake Control specified for this unique bike", 665, 3, 21, "BMW 6-Gears transmission", 3, new DateTime(2024, 4, 16, 18, 0, 2, 472, DateTimeKind.Local).AddTicks(1631) },
                    { 6, 20, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 100, 1, "BMW own Dynamic Traction Control specified for this unique bike", "BMW own Front Brake Control specified for this unique bike", 225, "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgIT2nOwQjqBRnWlaEFM8TWukwdyvwvGoWtqhfRxAh2-lTgX1EH_l689He3V3mEj_vQQ1Dk0WK7JET62OW-THslCCRxTvn13NKzxRa6XwwM2yi-KAKY3qVeNfjLnoIB6zpA0cH2MFT4Ue7fQTc1NePPzIfcYZIB0beSzdhzY1THSaUq8sAYpOXLhjgA7A/s1074/2023-BMW-R-nineT-100-Years-and-R18-100-Years.jpg", true, 190, "BMW RNineT", 82000m, "BMW own Rear Brake Control specified for this unique bike", 665, 3, 21, "BMW 6-Gears transmission", 5, new DateTime(2024, 4, 16, 18, 0, 2, 472, DateTimeKind.Local).AddTicks(1636) },
                    { 7, 20, new Guid("32b13a0b-6546-439e-a40d-4880e8a4e0a9"), 100, 1, "BMW own Dynamic Traction Control specified for this unique bike", "BMW own Front Brake Control specified for this unique bike", 225, "https://cdn.dealerspike.com/imglib/v1/800x600/imglib/trimsdb/17432641-0-110420261.jpg", true, 190, "BMW R1250GS", 82000m, "BMW own Rear Brake Control specified for this unique bike", 665, 3, 21, "BMW 6-Gears transmission", 6, new DateTime(2024, 4, 16, 18, 0, 2, 472, DateTimeKind.Local).AddTicks(1641) }
                });
